...
constexpr uint32_t MD5_HASH_SIZE = 16;
...
class MD5 {
    ...
    private:
        void transform(const uint8_t bolck[MD5_BLOCK_SIZE]);
        void update(const uint8_t *input, size_t length);
        void final(uint8_t digest[MD5_HASH_SIZE]);
...
// Constants for MD5 transformation functions
